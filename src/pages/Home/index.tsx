...
import { Col, Form, Row, Button, CardGroup } from 'react-bootstrap';
...
const Home = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    setUsers(oldUsers => [...oldUsers, userState]);
  ...
  return (
    <StyledContainer>
            ...
            <Row>
              <Col>
                <Form.Group className="mb-3" controlId="formName">
                  ...
                  <Form.Control
                    onChange={e =>
                      dispatchUser({ type: 'SET_NAME', value: e.target.value })
                    }
            ...
            <Row>
              <Col>
                <Form.Group className="mb-3" controlId="formEmail">
                  ...
                  <Form.Control
                    onChange={e =>
                      dispatchUser({ type: 'SET_EMAIL', value: e.target.value })
                    }
                    type="email"
            ...
            <Row>
              ...
              <Col>
                <Row>
                  <Button
                    onClick={() =>
                      dispatchUser({ type: 'FORM_CLEANUP', value: '' })
                    }
                  >
                    Limpar
                  </Button>
      ...
      <Button onClick={fetchReviews} className="bnt btn-light">
        Carregar mais comentários
      </Button>
      <Row className=" ">
        <CardGroup>
          {reviews?.map(review => {
            //math boolean random to display or not the ReviewCard (50% possibility of being true/false )
